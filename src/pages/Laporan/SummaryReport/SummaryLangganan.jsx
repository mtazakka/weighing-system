...
const SummaryLangganan = () => {
  const [value, setValue] = useState([null, null]);

  return (
    <Card withBorder pb={40} mt='lg'>
      <Divider my="xs" variant="dashed" labelPosition="center" label={<Text fz="lg">Per Supplier / Customer</Text>} />
      {/* End Title Container */}
      ...
      <Grid span={12} component="form" mx="auto" mt="xl">
        ...
        <Grid.Col span={5} offset={1}>
          <TextInput label="Supplier/Customer" withAsterisk name="suplierCustomer" placeholder="Supplier/Customer" />
        </Grid.Col>
        <Grid.Col span={5}>
          <DatePickerInput
            type="range"
...
export default SummaryLangganan;
